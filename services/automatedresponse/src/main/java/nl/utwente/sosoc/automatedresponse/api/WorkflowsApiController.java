package nl.utwente.sosoc.automatedresponse.api;
...
@Controller
@RequestMapping("${openapi.automatedResponseService.base-path:}")
public class WorkflowsApiController implements WorkflowsApi {

    private final NativeWebRequest request;

    @Autowired
    public WorkflowsApiController(NativeWebRequest request) {
