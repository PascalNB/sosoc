...
@JsonTypeName("Step_next_oneOf_inner")
...
public class StepNextOneOfInner {

  private @Nullable String condition;

  private @Nullable UUID next;

  public StepNextOneOfInner condition(String condition) {
  ...
  public StepNextOneOfInner next(UUID next) {
    this.next = next;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    StepNextOneOfInner stepNextOneOfInner = (StepNextOneOfInner) o;
    return Objects.equals(this.condition, stepNextOneOfInner.condition) &&
        Objects.equals(this.next, stepNextOneOfInner.next);
  }
  ...
  public String toString() {
    ...
    sb.append("class StepNextOneOfInner {\n");
